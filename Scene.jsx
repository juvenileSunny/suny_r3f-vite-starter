...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh name="Cube002" geometry={nodes.Cube002.geometry} material={materials.phong1SG} position={[0.853, 0.237, 1.366]} scale={2.316} />
      <group name="Wall" position={[0, -0.052, 0]} scale={4}>
        <mesh name="Plane" geometry={nodes.Plane.geometry} material={materials.Default} />
        <mesh name="Plane_1" geometry={nodes.Plane_1.geometry} material={materials['Floor.001']} />
      </group>
